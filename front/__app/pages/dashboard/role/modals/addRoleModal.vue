...
async function submitForm(e: Event) {
  ...
  try {
    await toast.promise(
      axios.post(apiRoutes.createRole, {
        name: data.name,
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="mb-2">
              ...
              <Textarea id="description" type="text" name="description" placeholder="Ex: Le gestionnaire du système." required
